...
public class QuestInitializer {
    ...
    public void initialize() {
        // Routine Quest
        questTemplateRepository.save(new QuestTemplate(9001, "Wake Up Early",
        ...
        questTemplateRepository.save(new QuestTemplate(9002, "Make Your Bed",
            "Begin your day with a tidy environment by making your bed.",
            ExperiencePoint.from(5), QuestionType.ROUTINE,
            StatInfo.of(StatType.STR, 1), null));

        questTemplateRepository.save(new QuestTemplate(9003, "Brush Your Teeth",
            "Maintain your dental hygiene by brushing your teeth.",
            ExperiencePoint.from(5), QuestionType.ROUTINE,
            StatInfo.of(StatType.STR, 1), null));

        questTemplateRepository.save(new QuestTemplate(9004, "Do Stretching",
            "Improve your flexibility and blood flow by doing some stretching.",
            ExperiencePoint.from(10), QuestionType.ROUTINE,
            StatInfo.of(StatType.STR, 1), null));

        questTemplateRepository.save(new QuestTemplate(9005, "Sleep Early",
            "Ensure a good night's sleep by going to bed early.",
            ExperiencePoint.from(5), QuestionType.ROUTINE,
            StatInfo.of(StatType.STR, 1), null));

        questTemplateRepository.save(new QuestTemplate(9006, "Ventilate Your Room",
        ...
        questTemplateRepository.save(new QuestTemplate(1, "Meditate for 5 Minutes",
            ...
            StatInfo.of(StatType.STR, 1), 300));
        ...
        questTemplateRepository.save(new QuestTemplate(2, "Gaze at Distant Mountains",
            ...
            StatInfo.of(StatType.SPI, 3), null));
	...
	StatInfo.of(StatType.KNO, 5), null));
        ...
        questTemplateRepository.save(new QuestTemplate(6, "Bask in the Sunlight",
            ...
            ExperiencePoint.from(10), QuestionType.TIMER,
            StatInfo.of(StatType.SPI, 2), 600));
        ...
        questTemplateRepository.save(new QuestTemplate(7, "Groom Yourself",
            ...
            ExperiencePoint.from(10), QuestionType.PHOTO,
            StatInfo.of(StatType.STR, 3), null));
        ...
        questTemplateRepository.save(new QuestTemplate(9, "Take a 15-minute Walk",
            ...
            StatInfo.of(StatType.PEA, 5), null));
        ...
        questTemplateRepository.save(new QuestTemplate(10, "Reflect on a Quote",
            ...
            StatInfo.of(StatType.KNO, 3), null));
	...
	ExperiencePoint.from(20), QuestionType.PHOTO,
	StatInfo.of(StatType.PEA, 7), null));
	...
	ExperiencePoint.from(20), QuestionType.PHOTO,
	StatInfo.of(StatType.KNO, 2), null));
	...
	ExperiencePoint.from(20), QuestionType.PHOTO,
	StatInfo.of(StatType.SPI, 5), null));
	...
	StatInfo.of(StatType.KNO, 7), 900));
	...
	StatInfo.of(StatType.KNO, 7), null));
	...
	ExperiencePoint.from(20), QuestionType.PHOTO,
	StatInfo.of(StatType.STR, 5), null));
	...
	ExperiencePoint.from(20), QuestionType.PHOTO,
	StatInfo.of(StatType.PEA, 10), null));
	...
	ExperiencePoint.from(20), QuestionType.PHOTO,
	StatInfo.of(StatType.STR, 7), null));
	...
	ExperiencePoint.from(20), QuestionType.PHOTO,
	StatInfo.of(StatType.PEA, 9), null));
	...
	ExperiencePoint.from(20), QuestionType.SHORT_ANSWER,
	StatInfo.of(StatType.SPI, 7), null));
	...
	ExperiencePoint.from(40), QuestionType.PHOTO,
	StatInfo.of(StatType.STR, 9), null));
	...
	StatInfo.of(StatType.STR, 7), 600));
	...
	ExperiencePoint.from(40), QuestionType.PHOTO,
	StatInfo.of(StatType.KNO, 9), null));
